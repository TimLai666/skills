...
| Skill | 適合什麼需求 |
| --- | --- |
| `ultrathink` | 想在產出文章、報告、提案、商業模式、程式等任何交付物之前，先依序跑過全部內建思考框架（目前含邏輯推導：MECE、空雨傘、魚骨圖；創意發想：六頂思考帽、腳本圖、心智圖；市場分析：3C 分析、SWOT 分析、4P與4C；進度管理：惠特默模型、KPI 樹狀圖），把方向與重點想清楚再動手。 |
