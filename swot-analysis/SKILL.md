...
使用以下框架進行外部環境分析（依情況選用）：

**PEST 分析**
| 面向 | 問題 |
|------|------|
| Political 政治 | 法規政策、政府態度、補貼或限制？ |
| Economic 經濟 | 景氣週期、消費力、原料成本、匯率？ |
| Social 社會 | 人口結構、消費習慣、價值觀變化？ |
| Technological 技術 | 新技術替代、數位轉型、供應鏈技術？ |

**產業五力（Porter）** — 用於識別競爭結構型威脅：
- 現有競爭者強度
- 新進者威脅
- 替代品威脅
- 買方議價力
...
2. 是否在未來 12-36 個月內將具體發生？
→ 兩題全過才列為有效 T；其餘降級為「觀察項」
```
