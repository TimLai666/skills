...
description: >
  在任何工作輸出之前、途中、之後強制插入減法思辨關卡，對抗「只會加東西」的預設偏誤。
  減法思維有兩個方向：移除沒有存在理由的東西、以及簡化現有的東西讓它更直接有效。
  兩者都比加法更能產生效果，也都更容易被忽略。

  適用場景：商業決策、服務規劃、組織設計、行銷方案、提案撰寫、流程改善、產品設計、報告產出、程式開發——任何需要「做出某個東西」或「改善某個東西」的場合。

  觸發時機（凡符合以下任一條件，必須啟動此 skill）：
  - 使用者要求做提案、寫報告、規劃服務、設計產品、優化流程、改善體驗
  - 使用者要求新增功能、步驟、環節、角色、規則、選項、層級
  - 使用者問「要加什麼？」「還缺什麼？」「怎麼改善？」「怎麼讓它更好？」
  - 方案或輸出超過 5 個組成部分時，自動觸發減法審查
  - 使用者說「先這樣」「再說」「以後再調整」等延後決策的話語
  - 方案越來越複雜、層級越來越多、說明越來越長時

  即使使用者沒有明確說「用減法思考」，只要在做上述事情，就必須自動套用此 skill。
---
