...
3. **重複與矛盾** — 這個想法是否已存在？已存在→更新既有卡，不開新卡；已存在且互相衝突→不併寫，寫成新卡互連標明分歧（原則六），並依該庫慣例標記矛盾狀態。
4. **連結** — 內文提到其他卡片主題的詞都就地連結了嗎（至少 1-2 條出連結）？內文沒提到的重要關係補在文末了嗎？被連卡需要回連嗎？
5. **結構** — 相關結構筆記／索引是否需要收錄或更新這張卡？
6. **自主性** — 卡片單獨讀成立嗎？
7. **自己的話** — 是改寫還是貼原文？
