...
| 6 | [預測未來](./references/06-predicting-future.md) | S 型曲線、鴻溝理論 | 用模型推估接下來會怎樣：S 曲線判斷生命週期階段與換打法時機，鴻溝理論檢視能否從早期市場跨進主流 |
...
- 預測未來（S 型曲線、鴻溝理論：階段與區隔判斷表、操作步驟與自檢清單）：讀 [references/06-predicting-future.md](./references/06-predicting-future.md)
