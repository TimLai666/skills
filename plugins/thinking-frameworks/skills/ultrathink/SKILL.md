...
| 5 | [權衡得失](./references/05-weighing-tradeoffs.md) | 決策矩陣 | 用最優原則取代滿意原則：關鍵標準加權評分、比較所有可見選項，決定不憑直覺 |
...
- 權衡得失（決策矩陣：操作步驟、對照範例與自檢清單）：讀 [references/05-weighing-tradeoffs.md](./references/05-weighing-tradeoffs.md)
