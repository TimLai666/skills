...
| 7 | [辯論思考](./references/07-debate-thinking.md) | 需根解損、判定立駁 | 把前面產出的方向與方案當辯題攻防後裁決：需根解損四關檢驗變更提案是否成立、判定立駁立好判準與定義後正反交鋒裁決價值主張；所有論點以主張、資料、推論三要素構建與攻擊 |
...
- 辯論思考（論點三要素、需根解損、判定立駁：操作步驟、對照範例與自檢清單）：讀 [references/07-debate-thinking.md](./references/07-debate-thinking.md)
