...
| 6 | [預測未來](./references/06-predicting-future.md) | S 型曲線 | 用模型推估接下來會怎樣：判斷生命週期階段，抓準換打法與佈局新曲線的時機 |
...
- 預測未來（S 型曲線：階段判斷表、操作步驟與自檢清單）：讀 [references/06-predicting-future.md](./references/06-predicting-future.md)
