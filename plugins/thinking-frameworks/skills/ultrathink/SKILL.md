...
| 7 | [思維模型](./references/07-mental-models.md) | 第一性原理、反向思考法、二階思考 | 跨領域思考紀律，兼作前面所有結論的總體檢：拆到本質重建、反向排雷、推演二階三階的連鎖反應 |
...
- 思維模型（第一性原理、反向思考法、二階思考：操作步驟、對照範例與自檢清單）：讀 [references/07-mental-models.md](./references/07-mental-models.md)
