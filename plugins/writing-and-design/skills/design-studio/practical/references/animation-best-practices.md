...
做動畫時，你不是在調 CSS transition——你是在用數位元素**模擬一個物理世界**，
...
3. **禮讓觀眾，比炫技更難**
   ...
   AI 預設會做一個沒有停頓的、資訊密度滿格的動畫——那是新手。你要做的是克制。
...
真實世界的物體有質量、有慣性、有彈性、會溢位。Anthropic 三支片子的「高級感」根源，
...
**共同潛台詞**：產品是**協作者、配對工程師、資深編輯**——不是一鍵魔術師。
...
- **品牌 / 旁白**：襯線（有「學術感 / 出版物感 / 品味」）
- **UI / 程式碼 / 資料**：無襯線 + 等寬

**單一字型都是不對的**。襯線給「品味」，無襯線給「功能」。
...
**呼叫順序**：
1. 先看 GUIDE.md 工作流程 Step 3 的form推導五問（決定敘事角色和視覺溫度）
