...
**❌ 激進漸層背景**
- 紫色 → 粉色 → 藍色 滿版漸層（AI生成網頁的典型味道）
- 任何方向的rainbow gradient
- Mesh gradient鋪滿背景
- ✅ 如果要用漸層：subtle、單色系、有意圖地點綴（比如button hover）
...
```
這種卡片在AI生成的Dashboard裡氾濫。想做強調？用更有設計感的方式：背景色對比、字重/字級對比、plain分隔線、或者乾脆不分卡片。
...
- 使用者知道他的受眾比你清楚
- 加內容有成本，使用者可能不想要
- 單方面加內容違反了"junior designer向上報告"的關係
...
- 影像：hero用full-bleed照片，feature section用placeholder等你提供
- 最多用2種背景色，避免雜亂
